...
/// <summary>
/// Standalone test program to verify all 4 market data channels
/// Tests Binance, OKX, Coinbase, and Kraken REST channels
/// </summary>
class TestMarketDataChannels
{
        ...
        where TChannel : class, IMarketDataChannel
    {
        ...
        try
        {
            ...
            var task = method.Invoke(channel, new object?[]
            {
                ...
                GetChannelInterval(channelName),  // interval
    ...
    static string GetChannelInterval(string channelName)
    {
        // Different channels may use different interval formats
