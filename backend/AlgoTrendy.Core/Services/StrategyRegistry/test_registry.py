...
def main():
    ...
    data_dir = Path("/root/AlgoTrendy_v2.6/data/strategy_registry")
    ...
    strategy1_id = manager.register_strategy(
        ...
        category="momentum",
        language="python",
        file_path="/root/AlgoTrendy_v2.6/strategies/development/strategy_research_2025_q4/strategy_1_volatility_managed_momentum/strategy1_vol_managed_momentum.py",
    ...
    strategy2_id = manager.register_strategy(
        ...
        language="python",
        file_path="/root/AlgoTrendy_v2.6/strategies/development/strategy_research_2025_q4/strategy_2_pairs_trading/strategy2_pairs_trading.py",
    ...
    strategy3_id = manager.register_strategy(
        ...
        category="carry",
        language="python",
        file_path="/root/AlgoTrendy_v2.6/strategies/development/strategy_research_2025_q4/strategy_3_carry_trade/strategy3_carry_trade.py",
